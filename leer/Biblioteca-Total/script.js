class LibraryHelper {
    constructor() {
        ...
        this.textVariables = [
            ...
            ['Los egipcios', 'Los mirmidones', 'Las nereidas', 'Los frigios', 'La alcmena', 'La amimone', 'Las danaides', 'La atalanta', 'El atamante', 'Los cabiros'],
            ['de Esquilo,'],
            ['el'], 
            ['número'], 
            ...
            ['el evangelio gnóstico de Basílides,', 'el evangelio griego de los egipcios,', 'el vangelio de los nazarenos,', 'el evangelio de los hebreos,', 'el evangelio de los ebionitas,'], 
            ['el'], 
            ['cantar', 'canto'], 
            ['que'], 
            ['cantaron', 'interpretaron', 'entonaron', 'chillaron', 'vocalizaron'], 
            ['las'], 
            ['sirenas,', 'rusalki,', 'lorelei,'], 
            ['el'], 
            ['catálogo', 'índice'], 
